...
from pytorch_seed_rl.functional import vtrace
...
def test_action_log_probs(batch_size=2):
    seq_len = 7
    num_actions = 3
...
def test_action_log_probs_batch_1():
    test_action_log_probs(1)


def test_vtrace(batch_size=5):
...
def test_vtrace_batch_1():
    test_vtrace(1)


def test_vtrace_from_logits(batch_size=2):
